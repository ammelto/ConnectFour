 ...
 * CS 1113 section 001
 * 
 * Description: This is a simple game of Connect Four using Swing
 * known bugs: 
 * 				Win message reappears when the window is refreshed if a new game is not created.
 * 
 * 				NullPointerException is created upon repaint after a winner is decided. This does not
 * 						affect the game play in anyway, will function as normal.
 * ========================================================================================
 */
...
public class ConnectFour extends JFrame implements ActionListener{
	...
	JDialog rWIN = redWin.createDialog("RED, A WINRAR IS YOU!");
	JDialog yWIN = yelWin.createDialog("YELLOW, A WINRAR IS YOU!");
	...
	public ConnectFour(){
		...
		//Uses AWT menu instead of JMenu because JMenu tends to disappear when
		//the pane is repainted. Not sure what causes this, so had to use AWT.
		menuBar = new MenuBar();
		...
		//Grid layout will adjust to the window size, graphic will not
		//Will look into this later and fix it if I can.
		//May have to give the buttons a static distance and make resizable(false);
